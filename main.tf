resource "aws_instance" "main" {
  ...
  tags = local.component_final_tags
}
...
resource "aws_launch_template" "main" {
  ...
  tag_specifications {
    ...
    tags = local.launch_template_final_tags
  }
...
resource "aws_autoscaling_group" "main" {
  ...
  # within 15 mins auto scaling should be successful, in 15 mins it wont come up and auto scaling will terminate the instance and launch a new one
  timeouts {
    delete = "15m"
  }
}
...
resource "aws_autoscaling_policy" "main" {
  ...
  target_tracking_configuration {
    ...
    target_value = 70.0  # if 70% CPU utilization is reached, auto scaling will launch a new instance
  }
}
